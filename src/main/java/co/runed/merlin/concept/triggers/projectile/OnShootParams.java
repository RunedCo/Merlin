...
public class OnShootParams extends EventParams<Event> {
    ...
    public OnShootParams(Event baseEvent, LivingEntity entity, ItemStack item, Entity projectile, float force, Vector velocity) {
        super(baseEvent);
