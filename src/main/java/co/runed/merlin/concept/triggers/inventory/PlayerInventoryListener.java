...
public class PlayerInventoryListener implements Listener {
    ...
    private void onPlayerClickInventory(InventoryClickEvent event) {
        ...
        SpellManager.getInstance().run(player, ClickInventoryTrigger.class, (spell, context) -> spell.onClickInventory(context.setEvent(event), new ClickInventoryParams(event)));
    }
